...
import (
	...
	"github.com/PhantomX7/go-pos/transaction/delivery/http/request"
...
func (a *TransactionUsecase) Update(transactionID int64, request request.TransactionUpdateRequest) (models.Transaction, error) {
