...
func (a *ProductUsecase) Index(paginationConfig request.ProductPaginationConfig) ([]models.Product, response.ProductPaginationMeta, error) {
	meta := response.ProductPaginationMeta{
